...
struct thread_data{
     ...
     */
    int wait_to_obtain_ms;         // sleep time before obtaining the mutex
    int wait_to_release_ms;        // hold time before release the mutex
    pthread_mutex_t* mutex;        // Pointer to a mutex for synchronization
